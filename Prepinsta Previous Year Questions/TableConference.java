...
public class TableConference {
    public static void main(String[]args){
        ...
        System.out.println("Possible Number ways of seating the members : "+possibleWays(member-1).multiply(BigInteger.valueOf(2)));
        scanner.close();
    }
    public static BigInteger possibleWays(int member){
...
/*
My Output :
Enter the Number of Members : 10
Possible Number ways of seating the members : 725760

Enter the Number of Members : 20
Possible Number ways of seating the members : 243290200817664000
 */