...
public class CollectionOfCurtains {
    public static void main(String[]args){
        ...
        System.out.print("Enter Curtain Colors using String : ");
        String color=scanner.nextLine();
        System.out.print("Enter the Number of Curtains in each box : ");
        int no=scanner.nextInt();
        System.out.println("Maximum Number of Aqua Colors : "+countAqua(color,no));
        scanner.close();
    }
    public static int countAqua(String color,int no){
        int max=0;
        int count=0;
...
/*
My Output : 
Enter Curtain Colors using String : bbbaaababa
Enter the Number of Curtains in each box : 3
Maximum Number of Aqua Colors : 3

Enter Curtain Colors using String : abbbaabbb
Enter the Number of Curtains in each box : 5
Maximum Number of Aqua Colors : 2
 */