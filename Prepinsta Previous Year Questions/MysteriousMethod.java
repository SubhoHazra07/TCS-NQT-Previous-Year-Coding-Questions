...
public class MysteriousMethod {
    public static void main(String[]args){
        ...
        System.out.print("Enter the another Number (R) : ");
        int R=scanner.nextInt();
        System.out.println("After doing Mysterious Method the Number is : "+mysteriousMethod(N,R));
        scanner.close();
    }
    public static int mysteriousMethod(int n,int r){
        if(r==0){
            return 0;
        }
        int sum=sumOfDigits(n);
        int rTimes=sum*r;
        return sumOfDigits(rTimes);
    }
...
/*
Output :
Enter the Number (N) : 99
Enter the another Number (R) : 3
After doing Mysterious Method the Number is : 9

Enter the Number (N) : 1234
Enter the another Number (R) : 2
After doing Mysterious Method the Number is : 2
 */